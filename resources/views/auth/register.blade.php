                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="ls-custom-select col-md-6">
                                <select name="sector_id" class="ls-select form-control" oninvalid="this.setCustomValidity('Selecione um setor!')" onchange="try{setCustomValidity('')}catch(e){}" required>
                                    @inject('sectors', '\App\Sector')
                                    <option value="" class=" form-control">Selecione um setor</option>
